...
// 		'$empr0002','$agen0002','$clie0002','$iemi0002','$femi0002','$loca0002',
// 		'$empr0003','$agen0003','$clie0003','$iemi0003','$femi0003','$loca0003',
// 		'$empr0004','$agen0004','$clie0004','$iemi0004','$femi0004','$loca0004',
// 		'$empr0016','$agen0016','$clie0016','$iemi0016','$femi0016','$loca0016' ";
...
while($datos_muestra=$pr->fetch(PDO::FETCH_ASSOC)) {
	...
	// $local = $datos_muestra["LOCAL"];

	$tienda_sunny = "";

	if($datos_muestra["LOCAL"]=='0000'){
		$tienda_sunny = "LIMA";
	}
	if($datos_muestra["LOCAL"]=='0001'){
		$tienda_sunny = "BARRANCA";
	}
	if($datos_muestra["LOCAL"]=='0002'){
		$tienda_sunny = "TRUJILLO";
	}
	if($datos_muestra["LOCAL"]=='0003'){
		$tienda_sunny = "HUARAL";
	}
	if($datos_muestra["LOCAL"]=='0004'){
		$tienda_sunny = "SANTA ROSA";
	}
	if($datos_muestra["LOCAL"]=='0005'){
		$tienda_sunny = "CHAO";
	}
	if($datos_muestra["LOCAL"]=='0006'){
		$tienda_sunny = "HUAURA";
	}
	if($datos_muestra["LOCAL"]=='0008'){
		$tienda_sunny = "CHIMBOTE";
	}
	if($datos_muestra["LOCAL"]=='0009'){
		$tienda_sunny = "TRAPICHE";
	}
	if($datos_muestra["LOCAL"]=='0011'){
		$tienda_sunny = "CASTILLA";
	}
	if($datos_muestra["LOCAL"]=='0012'){
		$tienda_sunny = "CHEPEN";
	}
	if($datos_muestra["LOCAL"]=='0013'){
		$tienda_sunny = "PIURA";
	}
	if($datos_muestra["LOCAL"]=='0014'){
		$tienda_sunny = "CHICLAYO";
	}
	...
	if(is_in_array($ar_stacol, 'LOCAL', $datos_muestra['LOCAL'])=='yes'){ // YES: SI EXISTE
		for($j=0;$j<=count($ar_stacol)-1;$j++){
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="0" ){
				$ar_stacol[$j]["0"] = $ar_stacol[$j]["0"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="1" ){
				$ar_stacol[$j]["1"] = $ar_stacol[$j]["1"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="2" ){
				$ar_stacol[$j]["2"] = $ar_stacol[$j]["2"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="3" ){
				$ar_stacol[$j]["3"] = $ar_stacol[$j]["3"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="4" ){
				$ar_stacol[$j]["4"] = $ar_stacol[$j]["4"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="5" ){
				$ar_stacol[$j]["5"] = $ar_stacol[$j]["5"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="6" ){
				$ar_stacol[$j]["6"] = $ar_stacol[$j]["6"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="7" ){
				$ar_stacol[$j]["7"] = $ar_stacol[$j]["7"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']=="8" ){
				$ar_stacol[$j]["8"] = $ar_stacol[$j]["8"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']>="0" && $datos_muestra['RANGO_VCTO']<="6"){
				$ar_stacol[$j]["0_6"] = $ar_stacol[$j]["0_6"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']>="0" && $datos_muestra['RANGO_VCTO']<="8"){
				$ar_stacol[$j]["0_8"] = $ar_stacol[$j]["0_8"]+$datos_muestra['SALDO_TOTAL_US'];				
			}
			if($ar_stacol[$j]["LOCAL"] == $datos_muestra['LOCAL'] && $datos_muestra['RANGO_VCTO']>="1" && $datos_muestra['RANGO_VCTO']<="6"){
		...
		if($datos_muestra['RANGO_VCTO']=="0"){
			array_push($ar_stacol,array(
				"LOCAL" 				=> $datos_muestra['LOCAL'],
				"TIENDA_SUNNY"			=> utf8_decode($tienda_sunny),
...
$xls->getActiveSheet()->getColumnDimensionByColumn(8)->setWidth(12);
...
$xls->getActiveSheet()->getColumnDimensionByColumn(13)->setWidth(12);
...
$xls->getActiveSheet()->getColumnDimensionByColumn(17)->setWidth(12);
...
$xls->getActiveSheet()->getColumnDimensionByColumn(22)->setWidth(12);
...
$xls->getActiveSheet()->getColumnDimensionByColumn(26)->setWidth(12);
$xls->getActiveSheet()->getColumnDimensionByColumn(27)->setWidth(12);
...
for($z=0;$z<=count($ar_stacol)-1;$z++){ 
	...
	$xfil=$xfil+1;
	$xls->getActiveSheet()->SetCellValue($columna[$xcol+0].$xfil, utf8_encode($ar_stacol[$z]['TIENDA_SUNNY']));
	...
	// $xls->getActiveSheet()->getStyle($columna[$xcol+16].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	// $xls->getActiveSheet()->getStyle($columna[$xcol+17].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	// $xls->getActiveSheet()->getStyle($columna[$xcol+18].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	...
	// $xls->getActiveSheet()->getStyle($columna[$xcol+25].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	// $xls->getActiveSheet()->getStyle($columna[$xcol+26].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
	// $xls->getActiveSheet()->getStyle($columna[$xcol+27].$xfil)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
...
$xls->getActiveSheet()->getStyle('B'.($xfil+1).':J'.($xfil+1))->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1); 
...
$xls->getActiveSheet()->setCellValue('A2','GENERAL %');
...
$xls->getActiveSheet()->getRowDimension(1)->setRowHeight(0); // OCULTA LA 1ERA FILA
$xls->getActiveSheet()->getRowDimension(3)->setRowHeight(0); // OCULTA LA 3ERA FILA

$date = new DateTime($fecha_envio);

header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="GERENCIAL PENDIENTES '.$date->format('Y-m-d H.i.s').' Sunny Valley.xlsx"');
