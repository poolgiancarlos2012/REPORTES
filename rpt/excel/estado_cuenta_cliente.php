...
// SE OMITIERON MAS EMPRESAS DEBIDO A QUE SOLO QUIERES QUE SE MUESTREN VENDEDORES DE ESA EMPRESAS
$defvend="	SELECT
...
$sqldocumentos = "		SELECT
						...
						CASE
						WHEN TM_DIAPLZ>0 THEN TM_DIAPLZ
						ELSE NULL END 'TRANSC',
...
$sunny2soles=0;$sunny2dolares=0;$cantsunny2=0; // 0016 SUNNY VALLEY S.A.C.
